...
#include "tf-psa-crypto/crypto_adjust_config_synonyms.h"
#include "tf-psa-crypto/crypto_adjust_config_auto_enabled.h"
#include "tf-psa-crypto/crypto_adjust_config_dependencies.h"
#include "tf-psa-crypto/crypto_adjust_config_key_pair_types.h"

/* Define additional internal symbols based on the library configuration. */
#include "tf-psa-crypto/crypto_adjust_config_derived.h"
 ...
 * accelerated. */
#include "mbedtls/crypto_adjust_config_enable_builtins.h"

#if defined(TF_PSA_CRYPTO_TEST_LIBTESTDRIVER1)
#include "mbedtls/libtestdriver1-crypto_adjust_config_enable_builtins.h"
#endif
...
#include "tf-psa-crypto/crypto_adjust_config_support.h"

/* Define additional symbols used by built-in crypto modules. */
#include "mbedtls/crypto_adjust_config_tweak_builtins.h"

#if defined(TF_PSA_CRYPTO_TEST_LIBTESTDRIVER1)
#include "mbedtls/libtestdriver1-crypto_adjust_config_tweak_builtins.h"
#endif
