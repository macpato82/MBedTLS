...
/* Norcroft's 32-bit CLib has no usable scalar C99 int64_t typedef. */
 ...
 */
/* RISC OS has no POSIX directory API; certificate files are opened by the
 * caller and parsed with mbedtls_x509_crt_parse(). */
